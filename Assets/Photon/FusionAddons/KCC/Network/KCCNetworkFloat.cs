...
namespace Fusion.Addons.KCC
{
    public sealed unsafe class KCCNetworkFloat<TContext> : KCCNetworkProperty<TContext> where TContext : class
    {
        ...
        public KCCNetworkFloat(TContext context, float accuracy, Action<TContext, float> set, Func<TContext, float> get,
            Func<TContext, float, float, float, float> interpolate) : base(context, 1)
        {
