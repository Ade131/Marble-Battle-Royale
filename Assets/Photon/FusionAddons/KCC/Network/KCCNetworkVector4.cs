...
namespace Fusion.Addons.KCC
{
    public sealed unsafe class KCCNetworkVector4<TContext> : KCCNetworkProperty<TContext> where TContext : class
    {
        ...
        public KCCNetworkVector4(TContext context, float accuracy, Action<TContext, Vector4> set,
            Func<TContext, Vector4> get, Func<TContext, float, Vector4, Vector4, Vector4> interpolate) : base(context,
            4)
        {
