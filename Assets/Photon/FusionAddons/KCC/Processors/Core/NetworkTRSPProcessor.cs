...
{
	/// <summary>
	///     Default processor implementation with support of [Networked] properties, runtime lookup synchronization, based on
	///     NetworkTRSP.
	...
	///     This implementation is fully compatible Area of Interest (AoI).
	/// </summary>
	public abstract class NetworkTRSPProcessor : NetworkTRSP, IKCCProcessor, IKCCProcessorProvider
    {
