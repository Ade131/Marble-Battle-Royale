namespace Fusion.Addons.KCC
{
	...
	///     This allows to reference processors indirectly, providing support for sharing/reuse of processor and defer
	///     processor selection based on provider current state.
	/// </summary>
