...
{
	/// <summary>
	///     Processor implementation based on ScriptableObject. Instances can be linked directly to Processors list in KCC
	///     settings.
	///     At runtime, this processor can be registered to KCC only via an external provider (for example
	///     ScriptableKCCProcessorProvider).
	/// </summary>
	public abstract class ScriptableKCCProcessor : ScriptableObject, IKCCProcessor
    {
