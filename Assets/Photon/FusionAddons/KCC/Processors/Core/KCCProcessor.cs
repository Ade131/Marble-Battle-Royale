...
{
	/// <summary>
	///     Default processor implementation without support of [Networked] properties. Runtime lookup and synchronization is
	///     supported.
	///     Execution of methods is fully supported on 1) Prefabs, 2) Instances spawned with GameObject.Instantiate().
	/// </summary>
