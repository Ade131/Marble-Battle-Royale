...
namespace Fusion.Addons.Physics
{
    public partial class NetworkRigidbody<RBType, PhysicsSimType>
    {
      ...
      public override void Teleport(Vector3? position = null, Quaternion? rotation = null)
        {
            if (Object.IsInSimulation == false) return;
      ...
      protected virtual void ApplyDeferredTeleport()
        {
            var moving = _deferredTeleport.moving;
      ...
      ///     as a flag to indicate that this teleport has a different To and From position/rotation target for the teleport
      ///     tick.
      /// </summary>
