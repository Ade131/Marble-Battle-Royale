...
namespace Fusion.Addons.Physics
{
  ...
  /// </summary>
  public abstract partial class NetworkRigidbody<RBType, PhysicsSimType> : NetworkRigidbodyBase,
        IStateAuthorityChanged, ISimulationExit
        ...
        where PhysicsSimType : RunnerSimulatePhysicsBase
    {
      ...
      protected PhysicsSimType _physicsSimulator;
        ...
        public override void Spawned()
        {
            ...
            if (IsProxy) SetRBIsKinematic(_rigidbody, true);
            ...
            else
            {
                ...
                if (Object.IsInSimulation == false) SetRBIsKinematic(_rigidbody, true);
            }
        }
        ...
        protected virtual void EnsureHasRunnerSimulatePhysics()
        {
            ...
            var timing = typeof(RBType) == typeof(Rigidbody)
                ? (PhysicsTimings)UnityEngine.Physics.simulationMode
                : (PhysicsTimings)Physics2D.simulationMode;
#else
      var timing =
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         (typeof(RBType) == typeof(Rigidbody) ? (PhysicsTimings)(Physics.autoSimulation ? PhysicsTimings.FixedUpdate : PhysicsTimings.Script) : (PhysicsTimings)Physics2D.simulationMode);
#endif
            ...
            Debug.LogWarning(
                $"No {typeof(PhysicsSimType).Name} present on NetworkRunner, but is required by {GetType().Name} on gameObject '{name}'. Adding one using default settings.");
