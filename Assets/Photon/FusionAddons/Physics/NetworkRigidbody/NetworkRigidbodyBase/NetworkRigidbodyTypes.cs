...
namespace Fusion.Addons.Physics
{
  ...
  [Flags]
    ...
    public struct TRSThresholds
    {
      ...
      /// </summary>
      [InlineHelp] public bool UseEnergy;
      ...
      /// </summary>
      [InlineHelp] [Unit(Units.Units)] public float Position;

      /// <summary>
      ///     The minimum Quanternion.Angle difference between the current rotation angle of the Rigidbody and interpolated
      ///     rotation, for interpolation to be applied.
      ///     If the angle between current and interpolated values are less than this, then the transform will not be moved for
      ///     interpolation,
      ///     allowing the Rigidbody to sleep, thus retaining cached friction states.
      ///     A value of 0 indicates that this threshold should not be factored in to determining if interpolation occurs.
      /// </summary>
      [InlineHelp] [Unit(Units.Degrees)] public float Rotation;
      ...
      ///     A value of 0 indicates that this threshold should not be factored in to determining if interpolation occurs.
      /// </summary>
      [InlineHelp] [Unit(Units.NormalizedPercentage)]
        public float Scale;

      /// <summary>
      ///     The default values for interpolation threshold tests.
      /// </summary>
      public static TRSThresholds Default => new()
        {
            UseEnergy = true,
            Position = 0.01f,
            Rotation = 0.01f,
