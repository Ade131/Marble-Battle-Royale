...
namespace Fusion.Addons.Physics
{
  ...
  public abstract partial class NetworkRigidbodyBase : NetworkTRSP, INetworkTRSPTeleport
    {
      /// <summary>
      ///     Enables synchronization of Scale. Keep this disabled if you are not altering the scale of this transform, to reduce
      ///     CPU utilization.
      /// </summary>
      [InlineHelp] [SerializeField] public bool SyncScale;

      /// <summary>
      ///     Enables synchronization of Parent. Keep this disabled if you are not altering the parent of this transform, to
      ...
      /// </summary>
      [InlineHelp] [SerializeField] protected Transform _interpolationTarget;

      /// <summary>
      ///     When disabled, rotation is stored in the <see cref="NetworkTRSPData" /> rotation field, which compresses rotation
      ///     to 32 bits using 'Smallest Three'.
      ...
      /// </summary>
      [InlineHelp] [SerializeField] public bool UsePreciseRotation;
      ...
      ///     Is reset to false when the transform when the transform is restored to its networked state during the simulation
      ///     loop.
      /// </summary>
      ...
      protected bool _targIsDirtyFromInterpolation;
        ...
        ///     This teleport is deferred until after physics has simulated, and captures position and rotation values both before
