...
namespace Fusion.Addons.Physics
{
  ...
  [DisallowMultipleComponent]
    ...
    public class NetworkRigidbody2D : NetworkRigidbody<Rigidbody2D, RunnerSimulatePhysics2D>
    {
      ...
      /// <inheritdoc />
      protected override bool IsRBSleeping(Rigidbody2D rb)
        {
            return rb.IsSleeping();
        }

      /// <inheritdoc />
      protected override void ForceRBSleep(Rigidbody2D rb)
        {
            rb.Sleep();
        }

      /// <inheritdoc />
      protected override void ForceRBWake(Rigidbody2D rb)
        {
            rb.WakeUp();
        }
      ...
      protected override bool IsStateBelowSleepingThresholds(NetworkRBData data)
        {
            ...
            if (((Vector2)data.LinearVelocity).sqrMagnitude >
                Physics2D.linearSleepTolerance * Physics2D.linearSleepTolerance) return false;
