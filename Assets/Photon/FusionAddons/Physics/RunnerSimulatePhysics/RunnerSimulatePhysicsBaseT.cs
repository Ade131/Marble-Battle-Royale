...
namespace Fusion.Addons.Physics
{
  ...
  public abstract class RunnerSimulatePhysicsBase<TPhysicsScene> : RunnerSimulatePhysicsBase
        where TPhysicsScene : struct, IEquatable<TPhysicsScene>
    {
      /// <summary>
      ...
      ///     Indicate if this additional scene should not resimulate.
      ///     Typically this will be Forward, if you want to simulate physics locally for non-networked objects (such as rag
      ///     dolls)
      /// </param>
      ...
      public void UnregisterAdditionalScene(TPhysicsScene scene)
        {
            ...
            int? found = null;
            for (var i = 0; i < _additionalScenes.Count; i++)
            ...
            if (found.HasValue) _additionalScenes.RemoveAt(found.Value);
        }
