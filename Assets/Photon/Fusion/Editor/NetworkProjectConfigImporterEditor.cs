...
namespace Fusion.Editor
{
    ...
    internal class NetworkProjectConfigImporterEditor : ScriptedImporterEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    EditorGUILayout.PropertyField(
                        extraDataSerializedObject.FindPropertyOrThrow(nameof(NetworkProjectConfigAsset.Config)));
                    extraDataSerializedObject.ApplyModifiedProperties();

                    EditorGUILayout.PropertyField(
                        serializedObject.FindProperty(nameof(NetworkProjectConfigImporter.PrefabOptions)));
                    ...
                    if (GUILayout.Button("Show Network Prefabs Inspector")) NetworkPrefabsInspector.ShowWindow();
                    ...
                    if (assetSerializedObject?.targetObject.GetType() == typeof(NetworkProjectConfigAsset))
                        ...
                        {
                            EditorGUILayout.PropertyField(
                                assetSerializedObject.FindPropertyOrThrow(nameof(NetworkProjectConfigAsset.Prefabs)));
                            EditorGUILayout.PropertyField(
                                assetSerializedObject.FindPropertyOrThrow(
                                    nameof(NetworkProjectConfigAsset.BehaviourMeta)));
                        }
                    else
                        EditorGUILayout.HelpBox("Asset failed to deserialize correctly. Please reimport.",
                            MessageType.Warning);
                }
            }
            finally
            ...
            if (rebuildPrefabTable) NetworkProjectConfigUtilities.RebuildPrefabTable();
        }
        ...
        private static void VersionInfoGUI()
        {
            ...
            if (_versionExpanded) EditorGUILayout.HelpBox(_allVersionInfo, MessageType.None);
        }
