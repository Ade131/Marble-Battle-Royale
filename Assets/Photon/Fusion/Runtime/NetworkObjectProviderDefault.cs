...
namespace Fusion
{
    public class NetworkObjectProviderDefault : Behaviour, INetworkObjectProvider
    {
      ...
      [InlineHelp] public bool DelayIfSceneManagerIsBusy = true;
        ...
        public virtual NetworkObjectAcquireResult AcquirePrefabInstance(NetworkRunner runner,
        ...
        public virtual void ReleaseInstance(NetworkRunner runner, in NetworkObjectReleaseContext context)
        {
            ...
            if (context.TypeId.IsPrefab) runner.Prefabs.RemoveInstance(context.TypeId.AsPrefabId);
        }
        ...
        protected virtual void DestroyPrefabInstance(NetworkRunner runner, NetworkPrefabId prefabId,
        ...
        protected virtual void DestroySceneObject(NetworkRunner runner, NetworkSceneObjectId sceneObjectId,
            NetworkObject instance)
        {
            Destroy(instance.gameObject);
        }
