...
namespace Fusion
{
    ...
    public sealed class NetworkCharacterController : NetworkTRSP, INetworkTRSPTeleport, IBeforeAllTicks, IAfterAllTicks,
        IBeforeCopyPreviousState
    {
        ...
        public void Teleport(Vector3? position = null, Quaternion? rotation = null)
        {
            ...
            Teleport(this, transform, position, rotation);
        ...
        {
            Render(this, transform, false, false, false, ref _initial);
        }
