...
namespace Fusion.Menu
{
  ...
  using InputField = UnityEngine.UI.InputField;
    ...
    ///     One speciality is that a region list is requested from the connection when entering the screen in order to create a
    ///     matching session codes.
    /// </summary>
    public partial class FusionMenuUIParty : FusionMenuUIScreen
    {
      ...
      public override void Awake()
        ...
        public override void Show()
        {
            ...
            if (Config.CodeGenerator == null) Debug.LogError("Add a CodeGenerator to the FusionMenuConfig");
