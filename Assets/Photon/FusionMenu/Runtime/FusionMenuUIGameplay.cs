...
namespace Fusion.Menu
{
  ...
  using Text = UnityEngine.UI.Text;
    ...
    public partial class FusionMenuUIGameplay : FusionMenuUIScreen
    {
      ...
      /// <summary>
      ///     The coroutine is started during Show() and updates the Usernames using this interval
      ///     <see cref="UpdateUsernameRateInSeconds" />.
      /// </summary>
      ...
      public override void Awake()
        ...
        public override void Show()
        {
            ...
            if (UpdateUsernameRateInSeconds > 0) _updateUsernamesCoroutine = StartCoroutine(UpdateUsernamesCoroutine());
        }
