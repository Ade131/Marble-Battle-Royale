...
namespace Fusion.Menu
{
  ...
  using Text = UnityEngine.UI.Text;
    ...
    /// <summary>
    ///     The version plugin is used to format informational parts of the <see cref="IFusionMenuConnectArgs" /> or
    ///     <see cref="IFusionMenuConnection" />.
    /// </summary>
    public class FusionMenuScreenPluginVersion : FusionMenuScreenPlugin
    {
      ...
      /// <summary>
      ///     The parent screen is shown. Use the connection object (is available) or the connection args to format a version
      ///     string.
      /// </summary>
      ...
      public virtual string GetInformationalVersion(IFusionMenuConnectArgs connectionArgs)
        {
            if (connectionArgs == null) return string.Empty;
            return CreateInformationVersion(
                string.IsNullOrEmpty(connectionArgs.Region) ? connectionArgs.PreferredRegion : connectionArgs.Region,
                connectionArgs.AppVersion);
        }
      ...
      public virtual string CreateInformationVersion(string region, string appVersion)
        {
            ...
            if (string.IsNullOrEmpty(appVersion) == false) list.Add(appVersion);
